  ...
  <div class="container">
    ...
    <div class="card">
      <div class="card-header">
        <h1 class="h3">Renouvellement</h1>
      </div>

      <div class="card-body">
        <form action="{{ route('contrat.employe.store') }}" method="POST">
          @csrf
          ...
          <div class="form-group">
            <div class="info-section">
              ...
              <input name="date_entree" type="date" id="date_entree" value="{{ $entretiensValides->first()->cv->dossier->date_reception ?? '2023-01-01' }}" class="form-control">
            </div>
