        ...
        <div class="col-xl-10">
            ...
            <div class="row g-0">
                ...
                <div class="card-body p-md-5 mx-md-4">
                    ...
                    <x-form.input name="password_confirmation" type="password"> Confirmer Mot de Passe </x-form.input>

                    <div class="text-center pt-1 mb-5 pb-1">
                        <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3"> S'inscrire </button>
                    </div>

                    <div class="d-flex align-items-center justify-content-center pb-4">
                        <p class="mb-0 me-2">Déjà enregistré?</p>
                        <a href="/front/login" type="button" class="btn btn-outline-danger"> Se connecter </a>
                    </div>
