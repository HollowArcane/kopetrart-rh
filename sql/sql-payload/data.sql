...
VALUES (1, 250000.00, '2024-11-27');    /* current smig */
...
VALUES (5, 'Rakoto', 'DIeu Donne', 'john.doe@example.com', '1990-01-01', 1, 300000.00, 1, 1, 1, '2024-01-01', '2025-01-01');
...
INSERT INTO mvt_staff_contract (id_staff, salary, id_staff_position, id_department, id_staff_contract, date_start, date_end)
VALUES (5, 300000.00, 1, 1, 1, '2024-01-01', '2025-01-01');

INSERT INTO mvt_staff_contract (id_staff, salary, id_staff_position, id_department, id_staff_contract, date_start, date_end)
VALUES (2, 600000.00, 2, 2, 2, '2024-02-01', NULL);

-- SMIG employee
INSERT INTO mvt_staff_contract (id_staff, salary, id_staff_position, id_department, id_staff_contract, date_start, date_end)
VALUES (3, 250000, 3, 3, 2, '2024-02-01', NULL);

-- senior employee
INSERT INTO mvt_staff_contract (id_staff, salary, id_staff_position, id_department, id_staff_contract, date_start, date_end)
VALUES (4, 3000000, 3, 3, 2, '2015-02-01', NULL);
